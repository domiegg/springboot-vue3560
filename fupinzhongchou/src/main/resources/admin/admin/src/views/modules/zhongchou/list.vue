            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '物资编号' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.wuziUuidNumber" placeholder="物资编号" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/fupinzhongchou/upload/zhongchouMuBan.xls"
                        >批量导入众筹数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('zhongchou','导入导出')"
                                style="display: inline-block"
                                action="fupinzhongchou/file/upload"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.wuziUuidNumber!= '' && this.searchForm.wuziUuidNumber!= undefined) {
                    params['wuziUuidNumber'] = '%' + this.searchForm.wuziUuidNumber + '%'
                }

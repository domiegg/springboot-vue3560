    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="物资原价" prop="wuziOldMoney">
                       <el-input v-model="ruleForm.wuziOldMoney"
                                 placeholder="物资原价" clearable  :readonly="ro.wuziOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="物资原价" prop="wuziOldMoney">
                           <el-input v-model="ruleForm.wuziOldMoney"
                                     placeholder="物资原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   wuziOldMoney: [
                              { required: true, message: '物资原价不能为空', trigger: 'blur' },

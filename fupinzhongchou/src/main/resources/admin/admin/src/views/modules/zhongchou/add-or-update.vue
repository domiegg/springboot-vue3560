    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='wuzi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物资现价" prop="wuziNewMoney">
                        <el-input v-model="wuziForm.wuziNewMoney"
                                  placeholder="物资现价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="物资现价" prop="wuziOldMoney">
                            <el-input v-model="ruleForm.wuziNewMoney"
                                      placeholder="物资现价" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        ...
        computed: {
            totalMoney: function() {
                ...
                total = this.wuziForm.wuziNewMoney * this.ruleForm.zhongchouKucunNumber;
